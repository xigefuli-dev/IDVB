...
public sealed partial class SessionOrchestrator
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Later survey statuses reuse the activation capture target.
    ...
    private async Task CaptureSurveyFrameOnDemandAsync()
    {
        ...
        try
        {
            ...
            // Keep the status overlay attached if the game window moved or resized.
            _lastGameBounds = frame.ClientBounds;
            _lastGameWindowHandle = frame.WindowHandle;
...
/*
 * 文件职责：SessionOrchestrator.Survey。
