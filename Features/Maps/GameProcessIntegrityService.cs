...
/// <summary>Checks whether Identity Vision Bridge was started with administrator privileges.</summary>
public static class GameProcessIntegrityService
{
    ...
    public static GameIntegrityStatus Check()
    {
        ...
        return new GameIntegrityStatus(
            ...
            !currentElevated,
            currentElevated
                ? "Identity Vision Bridge 已使用管理员权限启动。"
                : "Identity Vision Bridge 未使用管理员权限启动，请重新以管理员权限打开。");
    }
...
/*
 * 文件职责：GameProcessIntegrityService（历史兼容名称，当前仅检查 IDVB 自身权限）。
